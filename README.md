...
### ALMA Data Reduction
We will follow this tentative [program](docs/UdeC_program.pdf), with hands-on sessions based on these [ALMA data reduction notes](https://github.com/cornil-baiotto/Astro-Tutorials/blob/main/casa_almadr_2026v2.pdf). <br>
